                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12 form-group">
                        ...
                        <label for="alternatemobileNumber"><b>Enter Alternate Contact Number:</b></label>
                            <input type="number" id="alternatemobileNumber" name="alternatemobileNumber" pattern="^[6-9]\d{9}$" title="Enter Valid Mobile Number"  class="form-control form-control-lg">
                        </div>

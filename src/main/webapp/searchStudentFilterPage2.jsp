...
<% 
List<StudentDetails> studentdetail = (List<StudentDetails>)session.getAttribute("searchresult");
...
<form method="post" action="filter"><!-- from action -->
      ...
      <h6> <label style="color:#2366a6;">* Mandatory</label> </h6>
         <input style ="display:none;" type="text" id="textbox" name="textbox" class="form-control form-control-lg" placeholder="text">

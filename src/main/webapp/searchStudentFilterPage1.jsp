...
<%-- <% ArrayList<GmitBatches> batch = (ArrayList<GmitBatches>)request.getAttribute("batch");%> --%>
...
function dynamicOptionFunction(dynamicselectvalue){
	...
	if(dynamicselectvalue == "bloodgroup"){
		...
		optionArray = ["select|--Choose Option--","${fourbatches[0]}|${fourbatches[0]}",
...
<form method="post" action="searchDb"><!-- from action -->
      ...
      <h6> <label style="color:#2366a6;">* Mandatory</label> </h6>
         <input style ="display:none;" type="text" id="textbox" name="textbox" class="form-control form-control-lg" placeholder="Enter Here">
         <input style ="display:none;" type="number" id="numericvalue" name="numericvalue" class="form-control form-control-lg" placeholder="Enter Here" >
